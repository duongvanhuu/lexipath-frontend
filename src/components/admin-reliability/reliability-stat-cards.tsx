...
export type ReliabilityStatItem = {
  label: string;
  value: number;
...
export type ReliabilityStatCardsProps = {
  items: ReliabilityStatItem[];
};

export function ReliabilityStatCards({ items }: ReliabilityStatCardsProps) {
  return (
