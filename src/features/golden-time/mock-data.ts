...
export const MOCK_GOLDEN_TIME_DASHBOARD: GoldenTimeDashboardData = {
  ...
  queue: [
    { id: "1", word: "accomplish",  reason: "overdue",   skillKey: "meaning",     dueLabel: "Quá hạn 2 ngày" },
    { id: "2", word: "determine",   reason: "exam_miss", skillKey: "listening" },
    { id: "3", word: "negotiate",   reason: "weak",      skillKey: "usage" },
    { id: "4", word: "revenue",     reason: "due",       skillKey: "collocation", dueLabel: "Hôm nay" },
    { id: "5", word: "persevere",   reason: "due",       skillKey: "spelling",    dueLabel: "Hôm nay" },
    { id: "6", word: "collaborate", reason: "weak",      skillKey: "meaning" },
    { id: "7", word: "initiative",  reason: "overdue",   skillKey: "usage",       dueLabel: "Quá hạn 1 ngày" },
    { id: "8", word: "implement",   reason: "due",       skillKey: "listening",   dueLabel: "Hôm nay" },
  ],
  schedule: [
    {
      id: "now",
